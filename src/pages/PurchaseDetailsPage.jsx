    ...
    <div className="min-w-0 space-y-6">
      ...
      <section aria-labelledby="productos-compra" className="min-w-0 space-y-4">
        <div className="flex min-w-0 flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          {!form && !purchase.singleProduct ? <button className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl bg-brand px-4 py-2.5 text-sm font-extrabold text-on-brand hover:bg-brand-hover focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus disabled:opacity-60" data-purchase-trigger="new" disabled={busy} onClick={(event) => openForm('item', event)} type="button"><Plus aria-hidden="true" className="size-4 shrink-0" />Añadir producto</button> : null}
        </div>
